...
>('${api.value}')`;
            ...
            try {
              if (/字段说明/gi.test(name2)) {
                ...
                TypeResponse.value += [`export interface ${lodashExports.upperFirst(apiMethod.value)}Response {`, ...interfaceFieldStr, `}`].join("\n") + "\n\n";
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("h1", {
            ...
            vue.createElementVNode("small", null, [
              ...
              vue.unref(isSupported) && tables.value ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                vue.createTextVNode("  /  "),
                vue.createElementVNode("a", {
                  class: "copy",
